...
const Author = () => {
    document.title = "Author | Mosso - Personal Portfolio React Js Template"
    return (
        <React.Fragment>
            <div className="mosso-fn-wrapper">
                <main className="mosso_fn_content">
                    <div className="mosso_fn_author_page">
                            ...
                            <div className="fn__author_info">
                                ...
                                <div className="right_part">
                                    <div className="fn__metas">
                                        <span className="cat">Dublin</span>
                                        <span className="author">14 Posts</span>
                                    </div>
                                    <h1 className="title">Benjamin Smith</h1>
                                    <p className="desc">Benjamin Smith is a writer, speaker, and productivity expert known for his work on habit formation</p>
                                    <div className="fn__social_info">
                                        <div className="mosso_fn_mini_social">
                                            <ul>
                                                <li>
                                                    <Link className="facebook" to="https://facebook.com/" target="_blank">
...
-2429 -17z"/>
                        ...
                        <div className="fn__section_title" style={{marginBottom: "30px"}}>
                            <div className="container">
                                <div className="section_title_container">
                                    <h3 className="fn__title"><span className="text">Author Posts</span></h3>
